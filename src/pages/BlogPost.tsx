...
import { Calendar, User, ArrowLeft, Share2, Facebook, Instagram, Play } from 'lucide-react';
...
**View our cottages and book your stay today to combine fishing, adventure, and relaxation in one unforgettable trip.**`
    ...
    {
      id: 'pet-friendly-flyfishing',
      title: 'Bringing Your Dog to Rivendell: A Pet-Friendly Flyfishing Retreat in Mpumalanga',
      excerpt: 'Everything you need to know about bringing your small dog to Rivendell Trout Estate for a luxury, pet-friendly flyfishing getaway in Mpumalanga.',
      author: 'Rivendell Team',
      date: '2025-07-06',
      readTime: '7 min read',
      ...
      featured: false,
      content: `For many travellers, a weekend getaway is only complete when their four-legged companions come along for the adventure. At Rivendell Trout Estate, we understand that pets are family, which is why we welcome small breed dogs at our self-catering cottages nestled in the heart of Mpumalanga's flyfishing country.

Whether you're planning a quiet escape into nature or a focused flyfishing trip on the Spekboom River, Rivendell offers a rare combination: premium accommodation, pristine trout waters, and a pet-friendly policy designed for comfort, safety, and peace of mind.

Before packing up the car and clipping on the leash, here's everything you need to know about bringing your dog to Rivendell.

## A Pet-Friendly Policy with Nature in Mind

Rivendell is a working riverfront estate bordered by untamed bush and mountainous reserve. Because we share this land with wildlife—including leopards, baboons, snakes, and jackals—we've put careful thought into our pet policy to protect both your dog and our ecosystem.

Here's how it works:

- Only small breed dogs (roughly Jack Russell size or smaller) are permitted.
- No cats, birds, or large breed dogs can be accommodated.
- Dogs must be pre-approved before arrival and are subject to a R150 per dog per night fee.
- A maximum of two small dogs per cottage is allowed.
- Dogs must be on a leash at all times when outside the cottage.
- Dogs must sleep indoors, and muddy paws on beds or couches may incur a R500 cleaning fee per item.
- If any complaints are received from other guests or staff, you may be asked to remove your dog from the property.

We've welcomed many respectful and responsible pet owners over the years, and we continue to offer this privilege so long as our environment, wildlife, and other guests are not negatively affected.

## Why Pet Owners Love Staying at Rivendell

1. **Self-catering cottages with space and privacy**
Our accommodation is spaced generously throughout the valley, giving dogs and their owners plenty of room to enjoy quiet walks, private patios, and time away from crowds.

2. **Tranquil riverside setting**
While your pet relaxes in the shade of a cottage stoep, you can enjoy world-class flyfishing on the Spekboom River, just a short walk away. The sound of the river, the rustling of leaves, and the scent of pine create a sensory retreat for animals and humans alike.

3. **Access to Mpumalanga's best dog-friendly day trips**
Rivendell is located near Dullstroom, Sabie, and scenic forest drives, many of which feature dog-friendly picnic areas and open spaces.

## Preparing for Your Visit

To ensure a smooth stay for all guests (and their pets), here are a few reminders before you arrive:

- Bring a leash, bedding, food bowls, and any medications your dog may require.
- Stick to paths and cottage boundaries. Do not allow your pet to wander near the river unsupervised, as natural hazards like snakes or thorns are common.
- Avoid bringing anxious or reactive dogs. The calm of the estate is best suited to well-socialised pets.
- Leave no trace. Clean up after your pet and respect the quiet, natural environment that others come here to enjoy.

Please also note that the estate is not enclosed or fenced, and our river cottages open directly onto wild surroundings. For this reason, we strongly discourage off-leash activity, no matter how well-trained your dog may be.

## Safety First: Know the Risks

While Rivendell is a peaceful destination, it remains part of a wilderness corridor. The presence of wildlife such as leopards, caracal, jackals, and baboons means your pet may encounter unfamiliar scents or sounds.

We do not accept responsibility for injuries or loss of pets. Visitors must remain aware that nature, while beautiful, is also unpredictable.

Harming wildlife in any way carries serious consequences, including a R5000 fine and the cost of replacement for any animal harmed.

## What Past Guests Say

Many of our regulars return to Rivendell because their pets are welcomed, not just tolerated. Our cottages have hosted everything from quiet Schnauzers to playful French Bulldogs, each enjoying river walks, cozy fireside naps, and evenings under the stars.

"It's hard to find places that welcome pets and still feel luxurious. Rivendell struck the perfect balance. Our two little rescues were in heaven." — Julia, Sandton

## Booking Your Pet-Friendly Escape

Ready to plan a flyfishing weekend without leaving your best friend behind?

Rivendell Trout Estate offers pet-friendly accommodation near Lydenburg, with access to one of South Africa's most pristine rainbow trout rivers. Our cottages are private, well-equipped, and surrounded by nature.

Please be sure to:

- Mention your dog when booking
- Request and sign the Pet Policy Agreement
- Confirm the number and breed of pets travelling with you

Availability for pet-friendly units is limited, so early booking is advised, especially during holiday periods and peak fishing seasons.

## Visit, Fish, and Relax—Together

Whether you're casting a line on the Spekboom River, enjoying a quiet fire at your cottage, or taking in the natural beauty of the valley, Rivendell offers a retreat for pet lovers who appreciate peace, privacy, and nature.

Contact us today to book your pet-friendly stay, and we'll gladly help you plan a visit that works for both you and your four-legged travel companions.`
    },
    {
...
**Book your stay today and enjoy Rivendell Trout Estate with smoother access and the same unforgettable wilderness experience.**`
    ...
    return (
      <Layout>
        <div className="container mx-auto px-4 py-20 text-center">
          <h1 className="text-4xl font-playfair font-bold text-primary mb-4">Article Not Found</h1>
  ...
  const formatContent = (content: string) => {
    return content.split('\n\n').map((paragraph, index) => {
      if (paragraph.startsWith('## ')) {
        return <h2 key={index} className="text-2xl font-playfair font-bold text-primary mt-8 mb-4">{paragraph.replace('## ', '')}</h2>;
      } else if (paragraph.startsWith('### ')) {
        return <h3 key={index} className="text-xl font-playfair font-semibold text-primary mt-6 mb-3">{paragraph.replace('### ', '')}</h3>;
  ...
  return (
    <Layout
      seo={{
        title: `${post.title} | Rivendell Trout Estate Blog`,
        description: post.excerpt,
        keywords: "flyfishing South Africa, Mpumalanga trout fishing, luxury fishing retreats, rainbow trout tips"
      }}
    >
      {/* Back Navigation */}
      ...
      <section className="py-12 bg-gradient-to-br from-primary to-forest-light text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="mb-4">
              <span className="text-sm font-medium text-gold-soft bg-gold-soft/10 px-3 py-1 rounded-full">
                {post.category}
              </span>
            </div>
            ...
            <div className="flex items-center space-x-6 text-sm text-gold-soft">
        ...
        <div className="container mx-auto px-4 -mt-8">
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {post.image.includes('youtube.com/watch?v=') ? (
                // YouTube video thumbnail with play button overlay
                <div 
                  className="relative group cursor-pointer"
                  onClick={() => handleVideoClick(post.image)}
                >
                  <img
                    src={`https://img.youtube.com/vi/${post.image.split('v=')[1]?.split('&')[0]}/maxresdefault.jpg`}
                    alt={post.title}
                  ...
                  />
                  {/* Play button overlay */}
                  <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center group-hover:bg-opacity-40 transition-all duration-300 rounded-lg">
              ...
              <div
                className="w-full h-64 md:h-80 bg-muted border-2 border-dashed border-border flex items-center justify-center rounded-lg absolute top-0 left-0"
                style={{ display: 'none' }}
              >
                <div className="text-center p-4">
                  <p className="text-sm font-medium text-muted-foreground mb-2">Image required:</p>
                  <p className="text-lg font-mono font-bold text-primary">{post.image}</p>
                  <p className="text-xs text-muted-foreground mt-2">Upload to public folder</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="prose prose-lg max-w-none">
              {post.content ? formatContent(post.content) : (
                <div className="text-center py-12">
                  <p className="text-lg text-muted-foreground mb-4">Full article content coming soon!</p>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-forest-deep text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-playfair font-bold mb-4">
            Ready to Experience Rivendell?
          </h2>
          <p className="text-lg text-gold-soft mb-6 max-w-2xl mx-auto">
            Put these tips into practice during your luxury flyfishing retreat in Mpumalanga
          </p>
          <Button 
            asChild 
            size="lg"
